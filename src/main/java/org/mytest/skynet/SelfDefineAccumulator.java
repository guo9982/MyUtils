...
//        System.out.println("merge   returnResult="+returnResult+" , accumulator.returnResult="+accumulator.returnResult);
    ...
    private String myAdd(String v1, String v2) {
        ...
        /**
         * v1:normalMonitorCount=11|normalCameraCount=9|abnormalMonitorCount=1|abnormalCameraCount=3|abnormalMonitorCameraInfos= ~"0001":07553,07554,07556~"0002":55555,66666~"0001":07553,07554,07556~"0002":55555,66666
         * v2:normalMonitorCount=3|normalCameraCount=3|abnormalMonitorCount=1|abnormalCameraCount=3|abnormalMonitorCameraInfos=
         *
         */
